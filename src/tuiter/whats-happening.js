 ...
 return (
   <div className="row text-center">
     ...
     <div className="col-10">
       ...
       <div>
         <button className="rounded-pill btn btn-primary float-end mt-2 ms-3 me-2 ps-3 pe-3 fw-bold"
                 onClick={tuitClickHandler}>
           Tuit
         </button>
         <div className="text-primary display-inline overflow-auto text-nowrap text-start fs-2">
